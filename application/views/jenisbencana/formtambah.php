<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <?php echo form_open('jenisbencana/simpan', array('class' => 'form-horizontal')) ?>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="col-md-6">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="kodejenis" class="form-control">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="jenisbencana" class="form-control">
