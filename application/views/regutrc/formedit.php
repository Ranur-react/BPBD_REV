<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <?php echo form_open('regutrc/update', array('class' => 'form-horizontal')) ?>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="col-md-6">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="idregu" class="form-control" value="<?php echo $idregu;?>">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="regu" class="form-control"value="<?php echo $regu;?>">
