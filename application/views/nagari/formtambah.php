<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <?php echo form_open('nagari/simpantransaksi', array('class' => 'form-horizontal')) ?>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="col-md-6">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="kodenagari" class="form-control">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="namanagari" class="form-control">
                    ...
                    <div class="col-sm-4" style="width:60%">
                    <select class="form-control select2" style="width: 100%;" name="kode_kecamatan" id="kode_kecamatan" required>            
