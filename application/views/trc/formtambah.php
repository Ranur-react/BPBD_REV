<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <?php echo form_open('trc/simpantransaksi', array('class' => 'form-horizontal')) ?>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="col-md-6">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="kodetrc" class="form-control" value="<?php echo $kodetrc;?>" readonly>
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="namatrc" class="form-control">
                    ...
                    <div class="col-md-8">
                    <select class="form-control select2" style="width: 60%;" name="jeniskelamin">
                    ...
                    <div class="col-sm-4"  style="width: 60%;">
                        <input type="text" name="pendidikanakhir" class="form-control">
                    ...
                    <div class="col-sm-4" style="width:60%">
                    <select class="form-control select2" style="width: 100%;" name="koderegu" id="koderegu" required>            
