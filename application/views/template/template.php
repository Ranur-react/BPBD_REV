...
<span class="logo-mini"><img src="<?php echo 
				base_url().'images/logobpbd.jpg'?>" height="20" width="20"></span>
<!-- logo for regular state and mobile devices -->
<span class="logo-lg"><img src="<?php echo 
				base_url().'images/logobpbd.jpg'?>" height="40" width="40">
</a>
...
<img src="<?php echo base_url().'Template/uploadfoto/'.$id.'.jpg' ?>" width="30" height="=30" class="img-circle" alt="gambar">
...
<img src="<?php echo base_url().'Template/uploadfoto/',$id,'.jpg' ?>"  class="img-circle" alt="gambar">
<p>
 <?php echo $id?>                                           
...
<ol class="breadcrumb">
        <li><a href="<?php echo base_url().'index.php/template'?>"><i class="fa fa-dashboard"></i> Home</a></li>
